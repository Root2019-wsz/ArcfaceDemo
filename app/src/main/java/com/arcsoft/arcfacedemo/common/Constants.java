...
public class Constants {
    ...
    public static final String APP_ID = "BdJgqxWPGm3ZhZWtazdZBkU3pcQ9W4TS6Kbb2iGKjFiK";
    public static final String SDK_KEY = "DaEKqRxoAWvxhHMag1vNYA3cVJWk52N3YG18ie5nE1Nu";
